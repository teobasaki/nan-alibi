...
- [ ] **Task 10** UI 3열 레이아웃 + 용의자 카드
- [ ] **Task 11** 인터뷰 화면 + 타이핑 연출 + 표정
- [ ] **Task 12** 증거 카드 템플릿 렌더러
- [ ] **Task 13** 사건 보드 연결 + 모순 이펙트
- [ ] **Task 14** 최종 제출 + 사건 재구성  ← 컷 라인
- [ ] Task 15~16 (사전 생성 풀, 밸런스·데모)
...
- **UI가 아직 없다.** 현재 배포본은 "scaffold ok" 한 줄. Task 10부터가 표현 계층
